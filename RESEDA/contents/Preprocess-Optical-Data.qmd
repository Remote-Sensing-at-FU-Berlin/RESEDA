...
[![](E:/Work/Github_Repository/RESEDA/RESEDA/contents/img/1.png)](E:/Work/Github_Repository/RESEDA/RESEDA/contents/img/1.png)
...
[![]https://github.com/Remote-Sensing-at-FU-Berlin/RESEDA/blob/main/RESEDA/contents/img/2.png?raw=true)]https://github.com/Remote-Sensing-at-FU-Berlin/RESEDA/blob/main/RESEDA/contents/img/2.png?raw=true)
...
Insert the function for Bilinear Interpolation : is a resampling method that uses the distance-weighted average of the four nearest pixel values to estimate a new pixel value.
This applies to each raster file.

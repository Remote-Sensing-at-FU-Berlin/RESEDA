...
In this chapter, you will get to know two optical ([Landsat 8](https://blogs.fu-berlin.de/reseda/landsat-8/) & [Sentinel 2](https://blogs.fu-berlin.de/reseda/sentinel-2/)) and one SAR satellites ([Sentinel 1](https://blogs.fu-berlin.de/reseda/sentinel-1/)) in more detail. At the end of the chapter, you will know where and how to acquire individual or immense amounts of data.
...
[**Intro**](https://blogs.fu-berlin.de/reseda/acquire/#1)\
- get an overview of remote sensing applications and various satellite missions\
[**Sensor Basics**](https://blogs.fu-berlin.de/reseda/sensor-basics/)\
- repeat basic concepts of remote sensing imaging\
- deepen your knowledge about the four resolutions in RS\
[**Landsat Earthexplorer**](https://blogs.fu-berlin.de/reseda/usgs-earth-explorer/) & [**BIG DATA Download**](https://blogs.fu-berlin.de/reseda/landsat-big-data-download/)\
...
[**Sentinel SciHUB**](https://blogs.fu-berlin.de/reseda/usgs-earth-explorer/) & [**BIG DATA Download**](https://blogs.fu-berlin.de/reseda/landsat-big-data-download/)\
...
![](./Acquire-your-data_files/icon_agriculture.png){.alignleft .size-full width="90"}\
...
![](./Acquire-your-data_files/icon_soil.png){.alignright .size-full width="90"}\
...
![](./Acquire-your-data_files/icon_forest.png){.alignleft .size-full width="90"}\
...
![](./Acquire-your-data_files/icon_water.png){.alignright .size-full width="90"}\
...
![](./Acquire-your-data_files/icon_city.png){.alignleft .size-full width="90"}\
...
![](./Acquire-your-data_files/icon_fire.png){.alignright .size-full width="90"}\
...
![](./Acquire-your-data_files/icon_ice.png){.alignleft .size-full width="90"}\
...
There is a tremendous amount of free data products (**FREE**) provided by various remote sensing missions. We will take a closer look at three of them in the upcoming sections ([Landsat 8](https://blogs.fu-berlin.de/reseda/landsat-8/), [Sentinel 2](https://blogs.fu-berlin.de/reseda/sentinel-2/) and [Sentinel 1](https://blogs.fu-berlin.de/reseda/sentinel-1/)).\
Then again, companies, as *Digital Globe* and *Planet Labs*, offer very high quality commercial data products (**COMM**ercial) for large amounts of money (four-digit range or more). Nevertheless, such data is sometimes offered free of charge during Announcement of Opportunity (AO)-events or can be used for scientific purposes when you submit a project proposal (**PROP**osal) at any time. Additionally, it is worth to visit the mission websites, as there might be some selected sample data sets for free -- but pay attention to the user agreements!\
...
| Sentinel 2      |    ✔     |    X     |    X     | 06/2015 – today | [ESA SciHUB](https://scihub.copernicus.eu/dhus/#/home){target="_blank" rel="noopener"}            |
| Sentinel 3      |    ✔     |    X     |    X     | 02/2016 – today | [ESA SciHUB](https://scihub.copernicus.eu/dhus/#/home){target="_blank" rel="noopener"}            |
| RapidEye        |    X     |    ✔     |    ✔     | 02/2009 - today | [Planet EyeFind](https://www.planet.com/products/planet-imagery/){target="_blank" rel="noopener"} |
| **RADAR**       |          |          |          |                 |                                                                                                   |
| Sentinel 1      |    ✔     |    X     |    X     | 04/2014 - today | [ESA SciHUB](https://scihub.copernicus.eu/dhus/#/home){target="_blank" rel="noopener"}            |
| TerraSAR-X      |    X     |    ✔     |    ✔     | 06/2007 - today | [AIRBUS TSX Archive](https://terrasar-x-archive.terrasar.com/){target="_blank" rel="noopener"}    |
:::
:::

...
The prerequisite for this chapter is that you have [downloaded](./Download.qmd#EarthExplorer) and [preprocessed](./Preprocess.qmd) at least one Landsat 8 scene. If you completed the [EarthExplorer exercise](./Download.qmd#EarthExplorer) successfully, you should already own the Landsat 9 Level-2 scene of March 28, 2025 (ID: LC09_L2SP_193023_20250328_20250329_02_T1). You can download [the preprocessed scene here](https://box.fu-berlin.de/s/ztHcGQtXMKJbcXN/download?path=%2FLandsat_Data&files=LC081930232017060201T1-SC20180613160412.tif). We will use this image to explain the basic visualization tools in QGIS.

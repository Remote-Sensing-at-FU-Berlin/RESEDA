...
[![Location of Add Raster Layer-function in QGIS][![](./img/L08_QGIS_1.png.png)]{.aligncenter}](./img/L08_QGIS_1.png))
...
[![Choose a .tif-file for import in the file explorer](./img/vis_009.png){.aligncenter}](./img/vis_009.png)
...
[![Imported L8 dataset](./img/vis_010.png){.aligncenter}](./img/vis_010.png)
...
[![Choose Singleband gray for the Render type option and press OK](./img/vis_012.png){.aligncenter}](./img/vis_012.png)

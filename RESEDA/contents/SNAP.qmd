...
[BEAM](http://www.brockmann-consult.de/cms/web/beam/){target="_blank"},
NEST and [Orfeo](https://www.orfeo-toolbox.org/){target="_blank"}
...
[![](./SNAP_files/laptop_snap.png){.aligncenter}](./SNAP_files/laptop_snap.png)
...
-   **1 Toolbar**: Main menu and standard tools for saving/opening data
    products ![](./SNAP_files/SNAP_buttons_02.png){.alignnone .size-full
    .wp-image-895 loading="lazy" width="68" height="31"}, navigation
    over image data ![](./SNAP_files/SNAP_buttons_03.png){.alignnone
    .size-full .wp-image-896 loading="lazy" width="144" height="30"}, as
    well as point, line and polygon feature drawing tools
    ![](./SNAP_files/SNAP_buttons_04.png){.alignnone .size-full
    ...
    ![](./SNAP_files/SNAP_buttons_05.png){.alignnone .size-full
...
-   **4 Product Library**: browse and view metadata of your locally
    ...
    SciHUB servers. Have a look at chapter [ESA
    SciHUB](https://blogs.fu-berlin.de/reseda/esa-scihub/) for more
-   **5 Image View**: data you have loaded in your current session can
    ...
    ![](./SNAP_files/SNAP_buttons.png){.alignnone .size-full

...
[![Location of Add Raster Layer-function in QGIS](./img/class_01.png){.aligncenter}](./img/class_01.png)

In the file explorer window, navigate to the data folder which holds your L9 data and import a raster dataset. We will use a L9 scene showing Berlin (ID: LC09_L2SP_193023_20250328_20250329_02_T1) from the [L9 Download Exercise](https://remote-sensing-at-fu-berlin.github.io/RESEDA/RESEDA/contents/Download.html#EarthExplorer){rel="noopener" target="_blank"}. The spatial subset can be downloaded [here](https://box.fu-berlin.de/s/jKgt89pXJEmx2LE){ target="_blank"} directly:
...
img <- rast("./landsatdata/LC09_L2SP_193023_20250328_20250329_02_T1.tif")
...
[![](./img/cla_001.png){.aligncenter}](./img/cla_001.png)
...
Now you are ready to start training your classifier as described in the [next sections](./Classification-in-R.qmd#rf-classification)!
...
First, it is necessary to process the training samples in the form of a data frame. The necessary steps are described in detail in the [previous section](./Classification-in-R.qmd#prepare-samples-in-r).
...
legend("topright",
       legend = c("Mean", "T-test CI 95%", "Min-Max Range"),

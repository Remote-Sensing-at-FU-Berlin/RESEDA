...
In the following a profile with the most important characteristics of the sensor is given. For much more detailed information, please refer to the [Landsat 8 User Guide](https://www.usgs.gov/landsat-missions/landsat-8-data-users-handbook){target="_blank" rel="noopener"} and [Landsat 9 User Guide](https://www.usgs.gov/media/files/landsat-9-data-users-handbook){target=_"blank"}!

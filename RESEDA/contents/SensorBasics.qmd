...
In the following a profile with the most important characteristics of the sensor is given. For much more detailed information, please refer to the [Landsat 8 User Guide](https://www.usgs.gov/landsat-missions/landsat-8-data-users-handbook){target="_blank" rel="noopener"} and [Landsat 9 User Guide](https://d9-wret.s3.us-west-2.amazonaws.com/assets/palladium/production/s3fs-public/media/files/LSDS-2082_L9-Data-Users-Handbook_v1.pdf){target=_"blank"}!
...
A more comprehensive explanation of data product is given in the [Sentinel 1 user guide](https://ftp.itc.nl/pub/Dragon4_Lecturer_2018/ESA%20EEs%20and%20Sentinels%20Brochures%20pdf/Copernicus%20Sentinels%201,2,3/Sentinel-1%20User%20Handbook.pdf){target="_blank"}.

...
<a href="./img/orbit_geostat.png" target="_blank">
  <img src="./img/orbit_geostat.png" style="display: block; margin: auto; width: 100%; max-width: 600px; height: auto;" />
</a>

::: {style="margin: -10px 0 20px 0; text-align: center"}
<span style="color: #686868; font-size: small;">Geostationary orbiting satellite</span>
:::
...
Anyway, Level-0, Level-1A and Level-1B products are PDGS-internal products not made available to users! When browsing the [ESA SciHUB archive](./Download.qmd#SentinelScihub){target="_blank"}, you will be able to choose from Level-1C and Level-2A products:

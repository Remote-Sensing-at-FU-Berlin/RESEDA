...
[![](./img/copdata_1.png)](./Download.qmd#SentinelDataspace)
...
[![](./img/copdata_0.png)](./img/copdata_0.png)
...
[![](./img/(./img/copdata_1.png))](./img/copdata_1.png)
...
It makes sense to filter the results using the advanced search settings which can be found in the left area of the **1 Search Panel**.
